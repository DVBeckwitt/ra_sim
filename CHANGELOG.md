...
- **GUI and UX updates**
  ...
  - Restored main detector and caked figure right-drag panning after stale left-drag suppression could consume the right-button press; canvas button handling now normalizes Matplotlib/Tk integer, enum, and string button values while preserving wheel zoom.
