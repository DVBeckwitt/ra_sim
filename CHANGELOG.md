...
- **GUI and UX updates**
  ...
  - Fixed GUI-state JSON import and timing startup restore so saved-state restore suppresses intermediate simulation updates, defers caked-view refresh and Qr/Qz selector repaint, and schedules one post-restore update instead of hanging during partially restored state.
