...
- **Fitting and optimization**
  ...
  - Changed the radial detector background editor from Matplotlib widgets to a Tk/Pillow canvas popup so scale changes update the corrected detector preview without Matplotlib redraw lag.
