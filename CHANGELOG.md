...
- **Tests**
  ...
  - Extended `tests/test_gui_bragg_qr_manager.py` with direct coverage for the extracted Bragg-Qr runtime value helpers, overlay-entry derivation, runtime-binding, action, and window-lifecycle helpers.
