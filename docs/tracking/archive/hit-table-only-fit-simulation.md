...
branch for older monkeypatched process functions.
...
forwarding, and unchanged numeric residual outputs for the targeted paths.
...
- `python -m pytest -q tests/test_geometry_fitting.py` passed: 207 passed.
