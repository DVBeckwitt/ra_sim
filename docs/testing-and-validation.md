...
| Validation probes | `tests/test_plot_fig2_born_scaled_ht_near_zero.py` | `python -m pytest tests/test_plot_fig2_born_scaled_ht_near_zero.py -ra` | Standalone Fig. 2 HT/Parratt explorer defaults, GUI parameter state, divergence-safe `HT/Qz^2`, stitch modes, diagnostics, and CSV redraw behavior. | Untiered; direct pytest or full suite. |
