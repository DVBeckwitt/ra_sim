...
def test_analysis_outputs_visible_when_analyze_tab_selected() -> None:
    assert (
        analysis_visibility.analysis_outputs_visible(
...
def test_analysis_outputs_visible_is_false_when_simulation_tab_selected() -> None:
    assert (
        analysis_visibility.analysis_outputs_visible(
            control_tab_var=_FakeVar("simulation"),
            popout_open=False,
            assume_visible_when_unknown=False,
        )
        is False
